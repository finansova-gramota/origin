...
function es_submit_pages(e, url) {
	...
	if ( typeof es_shortcode_form !== 'undefined' && es_shortcode_form !== '' ) {
		...
		var str= "es_email="+ encodeURIComponent(es_email.value) + "&es_name=" + "new subscriber" + "&es_group=" + "Public" + "&timestamp=" + encodeURIComponent(date_now) + "&action=" + encodeURIComponent(mynumber);
