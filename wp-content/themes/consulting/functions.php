...
$GLOBALS['consulting_thinkup_theme_version'] = '1.0.6';
...
function consulting_translate($text) {
	$file = fopen(get_site_url().'/wp-content/themes/consulting/translation.csv', 'r');
...
add_action( 'after_setup_theme', 'consulting_translate');
